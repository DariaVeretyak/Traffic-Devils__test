(() => {
    ...
    da.init();
    var range_instance_1, range_instance_2, $range1 = $(".js-range-slider-1"), $range2 = $(".js-range-slider-2");
    ...
    document.querySelector(".hero__submit").addEventListener("click", (() => {
        script_reset();
        if (!input.value.trim()) showError("Fields are not filled"); else {
